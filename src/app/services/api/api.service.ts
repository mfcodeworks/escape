...
import { Post } from '../../main/core/post';
import { Comment } from '../../main/core/comment';
import { Profile } from '../../main/core/profile';
import { Notification } from '../../main/core/notification';
...
export class ApiService {
    ...
    deleteFcm(token: string): any {
        return this.http
        .delete(`${API_URL}/me/fcm/token/${token}`)
        .pipe(
            retry(1),
            catchError((error) => this.handleError(error))
        );
