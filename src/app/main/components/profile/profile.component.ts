...
export class ProfileComponent implements OnInit {
    ...
    displayLikes = new FormControl(this.user.profile.settings.displayLikes);
    privateAccount = new FormControl(this.user.profile.settings.privateAccount);
    unknownDevices = new FormControl(this.user.profile.settings.unknownDevices);
    ...
    updateSettings() {
        ...
        this.backend.updateUser(this.user.profile).subscribe(
            (user) => {
                ...
                this.user.profile.settings = user.settings;
                this.user.profile = user;
                this.user.cacheUser();
            },
            (error) => console.warn(error),
            () => console.log('Settings updated', this.user.profile.settings)
        );
    }
